...
const InlineCode: FC<PreparedTextProps> = ({ children }) => (
  <code className="bg-background-secondary/50 font-dmmono text-primary relative whitespace-pre-wrap rounded-sm p-1 text-sm">
    {children}
  </code>
)

const Code: FC<PreparedTextProps> = ({ className, children }) => {
...
// react-syntax-highlighter renders its own <pre>, so we just pass children through
